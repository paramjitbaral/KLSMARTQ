                ...
                <ChartCard title="Total Tokens per Office">
                    {tokensPerOffice.length > 0 ? (
                        <ResponsiveContainer>
                         ...
                         <EmptyChart message="No office data available to display." />
                    )}
                </ChartCard>
                <ChartCard title="Average Wait Times">
                    {waitTimes.length > 0 && waitTimes.some(d => d['Avg. Wait (mins)'] > 0) ? (
                        <ResponsiveContainer>
                        ...
                        <EmptyChart message="No completed tokens with wait times to analyze." />
                    )}
                </ChartCard>
                 <div className="lg:col-span-2">
                    <ChartCard title="Peak Hours">
                        {tokens.length > 0 ? (
                            ...
                            <EmptyChart message="No token data available for peak hour analysis." />
                        )}
                    </ChartCard>
                </div>
            </div>
